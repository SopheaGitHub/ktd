...
<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-warning">
		...
		<div class="panel-body">
		    <div class="media" style="background: #fcf8e3; padding:15px; border-radius:4px; border:1px solid #faebcc;">
			  	<div class="media-left media-top">
			    	<a href="#">
				    ...
				    <div class="row">
				    	...
				    	<div class="col-md-5 text-right">
			    			...
			    			<div>
						   	...
						   	<br />
						   	<div>
						   		<button class="btn btn-sm btn-default" disabled>Offer This Project</button>
						   	</div>
				    	</div>
				   	</div>
			  	</div>
